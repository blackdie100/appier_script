                        ...
                        if result.empty:
                            ...
                            if app_id is "3f7a5990e7cdd831255a":
                                ...
                                if result_and_exp.empty:
                                    ...
                                    AndroidName = '/home/ubuntu/nick/85/'+'27617149_'+str(RightNow)[0:-13].replace(" ", "").replace(".", "").replace(":", "").replace("-", "")+'_Android.csv'
                                ...
                                if result_ios_exp.empty:
                                    ...
                                    iOSName = '/home/ubuntu/nick/85/'+'27617149_'+str(RightNow)[0:-13].replace(" ", "").replace(".", "").replace(":", "").replace("-", "")+'_iOS.csv'
